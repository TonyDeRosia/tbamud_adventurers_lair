...
/**
 * Format a gold total into a display string.
 *
 * @param out         Buffer to receive the formatted string.
 * @param outsz       Size of the output buffer.
 * @param total_gold  Total amount in gold units; negative values are clamped to zero.
 */
