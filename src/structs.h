...
#define RETIRED_PC_CLASS_ID 9  /**< Former Adventurer class; reserved, never selectable. */
...
#define BODY_PROFILE_INSECTOID 9
#define BODY_PROFILE_WINGED_INSECTOID 10
#define BODY_PROFILE_CONSTRUCT 11
#define BODY_PROFILE_AMORPHOUS 12
#define BODY_PROFILE_FISH 13
#define BODY_PROFILE_PLANT 14
#define BODY_PROFILE_CENTAUROID 15
#define BODY_PROFILE_CRUSTACEAN 16
#define BODY_PROFILE_WINGED_QUADRUPED 17
#define BODY_PROFILE_TENTACLED 18
#define BODY_PROFILE_BAT 19
#define NUM_BODY_PROFILES      20
...
#define BODY_PART_MIDLEG_LEFT (1 << 16)
#define BODY_PART_MIDLEG_RIGHT (1 << 17)
#define BODY_PART_REARLEG_LEFT (1 << 18)
#define BODY_PART_REARLEG_RIGHT (1 << 19)
#define BODY_PART_FIN_LEFT (1 << 20)
#define BODY_PART_FIN_RIGHT (1 << 21)
#define BODY_PART_BRANCH (1 << 22)
#define BODY_PART_ROOT (1 << 23)
#define BODY_PART_CLAW_LEFT (1 << 24)
#define BODY_PART_CLAW_RIGHT (1 << 25)
#define BODY_PART_VALID_MASK ((1 << 26) - 1)
...
#define PRF_UNUSED22     22   /**< Reserved */
...
#define MAX_SKILLS            297    /**< Highest player ability/proficiency ID */
...
struct player_special_data_saved
{
  ...
  room_vnum last_room;    /**< Room VNUM from the last accepted quit/logout. */
...
struct descriptor_data
{
  ...
  unsigned long combat_prompt_round; /**< Runtime marker for one violence-round prompt. */
