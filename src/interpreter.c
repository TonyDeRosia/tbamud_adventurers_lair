...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "confiscate", "confiscate", POS_DEAD   , do_confiscate, LVL_IMMORT, 0 },
  { "smite"      , "smite"     , POS_DEAD   , do_smite     , LVL_IMMORT, 0 },
  { "slay"       , "slay"      , POS_DEAD   , do_slay      , LVL_IMMORT, 0 },
  ...
  { "dirdel"   , "dirdel"  , POS_DEAD    , do_deldir   , LVL_BUILDER, 0 },
...
// //   { "display"  , "disp"    , POS_DEAD    , do_display  , 0, 0 },
  ...
  {"offhand", "offhand", POS_RESTING, do_offhand, 0, 0},
  {"dual", "dual", POS_RESTING, do_offhand, 0, 0},
  {"dual wield", "dual wield", POS_RESTING, do_offhand, 0, 0},
  ...
  { "oload"    , "oload"   , POS_DEAD    , do_load     , LVL_BUILDER, 1 },
  ...
  { "mload"    , "mload"   , POS_DEAD    , do_load     , LVL_BUILDER, 2 },
  ...
  { "tome"      , "tom"     , POS_RESTING , do_tome     , 0, 0 },
...
//   { "prompt"   , "pro"     , POS_DEAD    , do_display  , 0, 0 },
  ...
  { "rreset"   , "rreset"  , POS_DEAD    , do_rreset   , LVL_BUILDER, 0 },
  ...
  { "skulk"    , "skulk"   , POS_STANDING, do_sneak    , 1, SKILL_SKULK },
  { "vanish"   , "van"     , POS_FIGHTING, do_vanish   , 1, 0 },
  { "nervepinch", "nervep" , POS_FIGHTING, do_nerve_pinch, 1, 0 },
  { "decapitate", "decap"  , POS_STANDING, do_decapitate, 1, 0 },
  { "embalm"   , "emb"     , POS_STANDING, do_embalm   , 1, 0 },
  ...
  { "tedit"    , "tedit"   , POS_DEAD    , do_tedit    , LVL_GOD, 0 },  /* Legacy text editor path; still active and functional. */
  ...
  { "zap"      , "zap"     , POS_SITTING , do_zap      , 1, 0 },
  ...
  { "azr"      , "azr"     , POS_DEAD    , do_azr      , LVL_IMPL, 0 },
...
void nanny(struct descriptor_data *d, char *arg)
{
  ...
  case CON_GET_PROTOCOL:
    ...
    case CON_ACCT_MENU: {
      ...
      if (!str_cmp(arg, "0") || !str_cmp(arg, "quit") || !str_cmp(arg, "exit")) {
        STATE(d) = CON_CLOSE;
        return;
      }
