...
/** True when an object may not leave its holder by normal transfer/drop. */
#define OBJ_CANT_DROP(obj) (OBJ_FLAGGED((obj), ITEM_NODROP) || OBJ_FLAGGED((obj), ITEM_CURSED))
...
#define SHADOW_SLOT_PROFILE_VALID(ch, idx) (GET_SHADOW_SLOT((ch), (idx)).combat_profile_valid)
#define SHADOW_SLOT_MAX_HIT(ch, idx)       (GET_SHADOW_SLOT((ch), (idx)).max_hit)
#define SHADOW_SLOT_AC(ch, idx)            (GET_SHADOW_SLOT((ch), (idx)).armor)
#define SHADOW_SLOT_HITROLL(ch, idx)       (GET_SHADOW_SLOT((ch), (idx)).hitroll)
#define SHADOW_SLOT_DAMROLL(ch, idx)       (GET_SHADOW_SLOT((ch), (idx)).damroll)
#define SHADOW_SLOT_MAX_MANA(ch, idx)      (GET_SHADOW_SLOT((ch), (idx)).max_mana)
#define SHADOW_SLOT_DAMNODICE(ch, idx)     (GET_SHADOW_SLOT((ch), (idx)).damnodice)
#define SHADOW_SLOT_DAMSIZEDICE(ch, idx)   (GET_SHADOW_SLOT((ch), (idx)).damsizedice)
#define SHADOW_SLOT_STR(ch, idx)           (GET_SHADOW_SLOT((ch), (idx)).str)
#define SHADOW_SLOT_INT(ch, idx)           (GET_SHADOW_SLOT((ch), (idx)).intel)
#define SHADOW_SLOT_WIS(ch, idx)           (GET_SHADOW_SLOT((ch), (idx)).wis)
#define SHADOW_SLOT_DEX(ch, idx)           (GET_SHADOW_SLOT((ch), (idx)).dex)
#define SHADOW_SLOT_CON(ch, idx)           (GET_SHADOW_SLOT((ch), (idx)).con)
#define SHADOW_SLOT_CHA(ch, idx)           (GET_SHADOW_SLOT((ch), (idx)).cha)
...
/** The valid room VNUM where the player last cleanly left the game. */
...
#define GET_TRAINS(ch)          CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.trains))
#define GET_CONVERTED_TRAINS(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.converted_trains))
...
#define GET_CAMPAIGN_REWARD_QP(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_reward_qp))
#define GET_CAMPAIGN_REWARD_GOLD(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_reward_gold))
#define GET_CAMPAIGN_REWARD_XP(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_reward_xp))
#define GET_CAMPAIGN_REWARD_TRAINS(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_reward_trains))
#define GET_CAMPAIGN_REWARD_PRACTICES(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_reward_practices))
#define GET_CAMPAIGN_TARGET_COUNT(ch) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_target_count))
#define GET_CAMPAIGN_TARGET_VNUM(ch, i) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_target_vnum[(i)]))
#define GET_CAMPAIGN_TARGET_ROOM(ch, i) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_target_room[(i)]))
#define GET_CAMPAIGN_TARGET_REQUIRED(ch, i) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_target_required[(i)]))
#define GET_CAMPAIGN_TARGET_REMAINING(ch, i) CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.campaign_target_remaining[(i)]))
...
#define SET_STUDY_LEARN_LEVEL(ch, i, lvl) do { CHECK_PLAYER_SPECIAL((ch), (ch)->player_specials->saved.study_learned_level[i]) = (lvl); } while(0)
...
#define GET_MOB_DOUBLE_ATTACK(ch) ((ch)->mob_specials.combat_double_attack)
#define GET_MOB_TRIPLE_ATTACK(ch) ((ch)->mob_specials.combat_triple_attack)
#define GET_MOB_FOURTH_ATTACK(ch) ((ch)->mob_specials.combat_fourth_attack)
#define GET_MOB_DOUBLE_CAST(ch)   ((ch)->mob_specials.combat_double_cast)
#define GET_MOB_TRIPLE_CAST(ch)   ((ch)->mob_specials.combat_triple_cast)
#define GET_MOB_FOURTH_CAST(ch)   ((ch)->mob_specials.combat_fourth_cast)
