...
ACMD(do_flee);
ACMD(do_kick);
enum combat_skill_result {
  COMBAT_SKILL_NOT_ATTEMPTED = 0,
  COMBAT_SKILL_ATTEMPTED
};
enum combat_skill_result perform_backstab(struct char_data *, struct char_data *, int, int);
enum combat_skill_result perform_bash(struct char_data *, struct char_data *, int, int, int);
enum combat_skill_result perform_kick(struct char_data *, struct char_data *, int, int, int);
ACMD(do_kill);
ACMD(do_order);
ACMD(do_opet);
